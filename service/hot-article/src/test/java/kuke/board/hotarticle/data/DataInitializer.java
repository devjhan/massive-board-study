...
public class DataInitializer {
    ...
    RestClient commentServiceClient = RestClient.create("http://localhost:9002");
    RestClient likeServiceClient = RestClient.create("http://localhost:9004");
    RestClient viewServiceClient = RestClient.create("http://localhost:9005");
    ...
    Long createArticle() {
         return articleServiceClient.post()
                ...
                .retrieve()
                .body(ArticleResponse.class).getArticleId();
    }
