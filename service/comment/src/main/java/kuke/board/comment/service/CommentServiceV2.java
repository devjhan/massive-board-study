...
public class CommentServiceV2 {
    ...
    private CommentV2 findParent(CommentCreateRequestV2 request) {
        ...
        return commentRepository.findByArticleAndPath(parentPath, request.getArticleId())
    ...
    private boolean hasChildren(CommentV2 comment) {
        return commentRepository.findDescendantTopPath(comment.getArticleId(), comment.getPath().getPath()).isPresent();
    }
    ...
    private void delete(CommentV2 comment) {
        ...
        if (!comment.isRoot()) {
            commentRepository.findByArticleAndPath(comment.getPath().getParentPath(), comment.getArticleId())
    ...
    public List<CommentResponse> readAllInfiniteScroll(Long articleId, Long lastPath, Long pageSize) {
