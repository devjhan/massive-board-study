...
public class LikeApiTest {
    ...
    void likePerformanceTest(ExecutorService executorService, Long articleId, String lockType) throws InterruptedException {
        ...
        System.out.println("lockType " + lockType + " starts.");
        ...
        System.out.println("lockType " + lockType + " ended at " + (endTime - startTime) / 1000000 + "ms");
        Long count = restClient.get()
                .uri("/v1/article-likes/articles/{articleId}/count", articleId)
                .retrieve()
                .body(Long.class);
        System.out.println("lockType " + lockType + " ended with " + count + " counts.");
    }
}
